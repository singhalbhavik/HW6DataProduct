#' Internal imports for sparseNumeric package
#'
...
#'
#' Converts a dense numeric vector to a \code{sparse_numeric} object by
#' storing only the non-zero entries.
#'
#' @name coerce_numeric_to_sparse_numeric
...
#'
#' Expands a \code{sparse_numeric} object to its full dense numeric
#' representation.
#'
#' @name coerce_sparse_to_numeric
